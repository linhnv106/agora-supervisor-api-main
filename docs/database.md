...
2. Apply this migration to database via [npm run migration:run](#run-migration).
...
1. Create seed file with

```sh
npm run seed:create -- --name=Post
```

Where `Post` is name of entity.
